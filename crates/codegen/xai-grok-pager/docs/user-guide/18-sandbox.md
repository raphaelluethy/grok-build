...
for the life of the session**. When you resume it (`grog --resume <id>`,
`grog --continue`, or `grog -r`), Grok restores that same profile automatically —
