//! Host clipboard image paste mediated by `grog wrap`.
//!
...
//! the inner `grog`) can solicit the host pasteboard. That is intentional and
//! acceptable for `grog wrap` because (1) the user opted into wrap on their
