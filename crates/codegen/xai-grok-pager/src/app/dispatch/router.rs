...
use super::auth::{
    dispatch_cancel_login, dispatch_login, dispatch_login_provider, dispatch_logout,
    dispatch_set_provider, dispatch_submit_auth_code, dispatch_switch_account,
};
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetProvider(id) => dispatch_set_provider(app, id),
        Action::LoginProvider(id) => dispatch_login_provider(app, id),
