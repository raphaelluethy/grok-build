...
pub(super) fn default_actions(
    ...
    let mut actions = vec![
        ...
        ActionDef {
            ...
            default_key: key!('m', CONTROL | SHIFT),
            alt_keys: vec![],
            category: Category::Session,
            context: When::AgentScreen,
            hint_priority: None,
            ...
            requires_confirmation: false,
            long_help: Some(
                "Opens the reasoning-effort picker for the current model without re-picking the model.\nBound to Ctrl+Shift+M.\nIf the current model has no effort options, shows an error instead of an empty picker.",
            ),
        },
        ActionDef {
            id: ActionId::EffortDown,
            label: "effort down",
            description: "Lower thinking effort",
            default_key: key!(',', ALT),
            alt_keys: vec![],
            category: Category::Session,
            context: When::AgentScreen,
            ...
            requires_confirmation: false,
            long_help: Some(
                "Steps to a weaker thinking-effort option on the current model.\nBound to Alt+, (Option+, on macOS).\nUses advertised level strength (none < … < max), not menu order; clamps at the weakest offered value.",
            ),
        },
        ActionDef {
            id: ActionId::EffortUp,
            label: "effort up",
            description: "Raise thinking effort",
            default_key: key!('.', ALT),
            alt_keys: vec![],
            category: Category::Session,
            context: When::AgentScreen,
            ...
            requires_confirmation: false,
            long_help: Some(
                "Steps to a stronger thinking-effort option on the current model.\nBound to Alt+. (Option+. on macOS).\nUses advertised level strength (none < … < max), not menu order; clamps at the strongest offered value.",
            ),
        },
        ActionDef {
