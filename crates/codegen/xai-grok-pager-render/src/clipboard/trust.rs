...
///
/// - `osc52_sink`: when `grog wrap` is capturing this process's output (see
...
mod tests {
    ...
    // `grog wrap` sink: a brand that does NOT natively support OSC 52 (the
    ...
    // container override is deliberately narrow; `grog wrap` is the SSH path.
    #[test]
