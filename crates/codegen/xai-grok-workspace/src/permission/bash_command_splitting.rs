...
///
/// ```bash
/// XAI_API_KEY='xai-some-key' cargo run --bin grog
/// ```
///
...
///   highlighted_words: ["cargo", "run", "--bin", "grog"]
///   suffix: []
...
mod tests {
    ...
    fn test_parse_plain_commands_from_script() {
        ...
        let environment_key_command = "XAI_API_KEY='xai-some-key' cargo run --bin grog";
        assert_eq!(
        ...
        let redirection_command = "cargo build --bin grog 2>&1";
        assert_eq!(
